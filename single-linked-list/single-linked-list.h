...
public:
    ...
    SingleLinkedList(ContainerIterator begin, ContainerIterator end)
        : size_(0)
    {
        auto insert_it = before_begin();
        for (auto it = begin; it != end; ++it)
            insert_it = InsertAfter(insert_it, *it);
    }

    SingleLinkedList(std::initializer_list<Type> values)
    {
        SingleLinkedList copy(values.begin(), values.end());
    ...
    {
        SingleLinkedList copy(other.begin(), other.end());
